...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject applies an accumulator using the first identity item related to the accumulation function.
  end
  ...
  # In case the File did not open successfully, the block is not executed.
